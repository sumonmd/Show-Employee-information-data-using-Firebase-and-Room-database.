...
/*ServerFragment work with Artist Model, MyFireAdapter and MyDatabase */
    ...
    // Retrive data from Firebase asynchronously
        databaseArtists.addValueEventListener(new ValueEventListener() {
            ...
            for(DataSnapshot dataSnapshot1 : dataSnapshot.getChildren())
            {
                ...
                Artist p = dataSnapshot1.getValue(Artist.class);
                list.add(p);
            }
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try{
                ...
                for(int i = 0; i< jsonArray.length();i++){
                    ...
                    Artist artist = new Artist(id, name, designation,team,image);// Artist is a model for ServerFragment
